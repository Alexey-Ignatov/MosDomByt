...
class OrderFinalViewAdapter(val items : ArrayList<OrderPostition>, val context: Context) : androidx.recyclerview.widget.RecyclerView.Adapter<OrderFinalViewAdapter.ViewHolder>() {
